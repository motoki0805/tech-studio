...
export const SKILLS: SkillCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 11, name: "Next.js", icon: SiNextdotjs, color: "text-gray-800 dark:text-white", level: "B", years: "1年" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 17, name: "GitHub", icon: SiGithub, color: "text-gray-800 dark:text-white", level: "A", years: "3年" },
