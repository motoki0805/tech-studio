...
export const profile: Profile = {
  ...
  hobby: {
    ...
    description: [
      {
        id: 1,
        text: "色々な人とコミュニケーションを取るのが目的で始めました。そこからVR空間でのエンジニア集会などを知り、場所に縛られずにリアルタイムで情報交換ができるのが面白いと感じています。",
      },
      {
        id: 2,
        text: "食べ歩きは、休日に大須商店街で新しいお店探しをしています。美味しいものを食べることは自分にとって良いリフレッシュになっています。",
      },
    ],
  },
  qualityPolicy: {
